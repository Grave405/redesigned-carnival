local Library =
loadstring(game:HttpGetAsync("https://github.com/ActualMasterOogway/FluentRenewed/releases/latest/download/Fluent.luau"))()
local SaveManager =
...
Description = "This allows you to join our Discord server and get update pings
and more.",
Callback = function()
Window:Dialog({
Title = "Join Our Discord",
Content = "Would you like to copy the invite link to our Discord
server?",
Buttons = {
{
Title = "Confirm",
...
local Toggle = Tabs.Main:CreateToggle("AutoRep", {Title = "Auto Lift", Default =
false})
...
local punchTool = player.Backpack:FindFirstChild("Punch") or (char and
...
local autoWeightToggle = Tabs.Main:CreateToggle("AutoWeight", {Title = "Auto
...
local tool =
game.Players.LocalPlayer.Character:FindFirstChild("Weight")
...
local autoPushupToggle = Tabs.Main:CreateToggle("AutoPushups", {Title = "Auto
Pushups", Default = false})
autoPushupToggle:OnChanged(function(state)
if state then
task.spawn(function()
while autoPushupToggle.Value do
local tool =
game.Players.LocalPlayer.Character:FindFirstChild("Pushups")
if tool and tool:IsA("Tool") then
tool:Activate()
end
task.wait(0.2)
...
local autoSitupToggle = Tabs.Main:CreateToggle("AutoSitups", {Title = "Auto
Situps", Default = false})
autoSitupToggle:OnChanged(function(state)
if state then
task.spawn(function()
while autoSitupToggle.Value do
local tool =
game.Players.LocalPlayer.Character:FindFirstChild("Situps")
if tool and tool:IsA("Tool") then
tool:Activate()
end
task.wait(0.2)
...
local autoHandstandToggle = Tabs.Main:CreateToggle("AutoHandstands", {Title = "Auto
Handstands", Default = false})
autoHandstandToggle:OnChanged(function(state)
if state then
task.spawn(function()
while autoHandstandToggle.Value do
local tool =
game.Players.LocalPlayer.Character:FindFirstChild("Handstand")
if tool and tool:IsA("Tool") then
tool:Activate()
end
task.wait(0.2)
...
local fastWeightToggle = Tabs.Main:CreateToggle("FastWeight", {Title = "Auto Fast
Weight", Default = false})
fastWeightToggle:OnChanged(function(state)
while state and fastWeightToggle.Value do
local player = game.Players.LocalPlayer
local char = player.Character
local tool = player.Backpack:FindFirstChild("Weight") or (char and
char:FindFirstChild("Weight"))
if tool then
...
local fastPushupToggle = Tabs.Main:CreateToggle("FastPushups", {Title = "Auto Fast
Pushups", Default = false})
fastPushupToggle:OnChanged(function(state)
while state and fastPushupToggle.Value do
local player = game.Players.LocalPlayer
local char = player.Character
local tool = player.Backpack:FindFirstChild("Pushups") or (char and
char:FindFirstChild("Pushups"))
if tool then
if tool.Parent ~= char then
tool.Parent = char
task.wait(0.1)
...
local fastSitupToggle = Tabs.Main:CreateToggle("FastSitups", {Title = "Auto Fast
Situps", Default = false})
fastSitupToggle:OnChanged(function(state)
while state and fastSitupToggle.Value do
local player = game.Players.LocalPlayer
local char = player.Character
local tool = player.Backpack:FindFirstChild("Situps") or (char and
char:FindFirstChild("Situps"))
if tool then
if tool.Parent ~= char then
tool.Parent = char
task.wait(0.1)
...
local fastHandstandToggle = Tabs.Main:CreateToggle("FastHandstands", {Title = "Auto
Fast Handstands", Default = false})
fastHandstandToggle:OnChanged(function(state)
while state and fastHandstandToggle.Value do
local player = game.Players.LocalPlayer
local char = player.Character
local tool = player.Backpack:FindFirstChild("Handstand") or (char and
char:FindFirstChild("Handstand"))
if tool then
if tool.Parent ~= char then
tool.Parent = char
task.wait(0.1)
...
local jungleBenchToggle = Tabs.Main:CreateToggle("JungleBench", {Title = "Auto
Jungle Bench", Default = false})
jungleBenchToggle:OnChanged(function(State)
if State then
task.spawn(function()
while jungleBenchToggle.Value do
game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(CFrame.new(-8629.88086,
64.8842468, 1855.03467))
game:GetService("ReplicatedStorage").rEvents.machineInteractRemote:InvokeServer("us
eMachine", workspace.machinesFolder["Jungle Bench"].interactSeat)
task.wait(0.1)
end
end)
end
end)
local jungleBarToggle = Tabs.Main:CreateToggle("JungleBar", {Title = "Auto Jungle
Bar Lift", Default = false})
jungleBarToggle:OnChanged(function(State)
if State then
task.spawn(function()
while jungleBarToggle.Value do
game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(CFrame.new(-8678.05566,
14.5030098, 2089.25977))
game:GetService("ReplicatedStorage").rEvents.machineInteractRemote:InvokeServer("us
eMachine", workspace.machinesFolder["Jungle Bar Lift"].interactSeat)
task.wait(0.1)
end
end)
end
end)
local jungleSquatToggle = Tabs.Main:CreateToggle("JungleSquat", {Title = "Auto
Jungle Squat", Default = false})
jungleSquatToggle:OnChanged(function(State)
if State then
task.spawn(function()
while jungleSquatToggle.Value do
game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(CFrame.new(-8374.25586,
34.5933418, 2932.44995))
game:GetService("ReplicatedStorage").rEvents.machineInteractRemote:InvokeServer("us
eMachine", workspace.machinesFolder["Jungle Squat"].interactSeat)
...
local equipWeightToggle = Tabs.Main:CreateToggle("EquipWeight", {Title = "Auto
Equip Weight", Default = false})
equipWeightToggle:OnChanged(function(State)
if State then
task.spawn(function()
while equipWeightToggle.Value do
local tool =
game.Players.LocalPlayer.Backpack:FindFirstChild("Weight")
...
local equipPushupToggle = Tabs.Main:CreateToggle("EquipPushups", {Title = "Auto
Equip Pushups", Default = false})
equipPushupToggle:OnChanged(function(State)
if State then
task.spawn(function()
while equipPushupToggle.Value do
local tool =
game.Players.LocalPlayer.Backpack:FindFirstChild("Pushups")
if tool then tool.Parent = game.Players.LocalPlayer.Character end
task.wait(0.1)
end
end)
...
local equipSitupToggle = Tabs.Main:CreateToggle("EquipSitups", {Title = "Auto Equip
Situps", Default = false})
...
local tool =
game.Players.LocalPlayer.Backpack:FindFirstChild("Situps")
if tool then tool.Parent = game.Players.LocalPlayer.Character end
task.wait(0.1)
end
end)
...
local equipHandstandToggle = Tabs.Main:CreateToggle("EquipHandstands", {Title =
"Auto Equip Handstands", Default = false})
...
local tool =
game.Players.LocalPlayer.Backpack:FindFirstChild("Handstand")
if tool then tool.Parent = game.Players.LocalPlayer.Character end
task.wait(0.1)
end
end)
...
-- Auto Rebirth (Normal)
local autoRebirthToggle = Tabs.Rebirth:CreateToggle("AutoRebirth", {Title = "Auto
Rebirth (Normal)", Default = false})
autoRebirthToggle:OnChanged(function(State)
if State then
task.spawn(function()
while autoRebirthToggle.Value do
game:GetService("ReplicatedStorage"):WaitForChild("rEvents"):WaitForChild("rebirthR
emote"):InvokeServer("rebirthRequest")
task.wait(0.1)
end
end)
end
...
-- Auto Size 2
local autoSize2Toggle = Tabs.Rebirth:CreateToggle("AutoSize2", {Title = "Auto Size
2", Default = false})
autoSize2Toggle:OnChanged(function(State)
if State then
autoSizeLoop = task.spawn(function()
while autoSize2Toggle.Value do
game:GetService("ReplicatedStorage").rEvents.changeSpeedSizeRemote:InvokeServer("ch
angeSize", 2)
task.wait()
end
end)
...
-- Hide All Frames
local hideFramesToggle = Tabs.Rebirth:CreateToggle("HideAllFrames", {Title = "Hide
All Frames", Default = false})
...
-- Fast Rebirths
local fastRebirthsToggle = Tabs.Rebirth:CreateToggle("FastRebirths", {Title = "Fast
Rebirths", Default = false})
fastRebirthsToggle:OnChanged(function(State)
if State then
loadstring(game:HttpGet("https://raw.githubusercontent.com/0o0o0o0o0o0o0o0o0o0o0o0o
/0o0o0o0o/refs/heads/main/Kk"))()
end
end)
-- Speed Grind (No Rebirth)
local speedGrindToggle = Tabs.Rebirth:CreateToggle("SpeedGrind", {Title = "Fast
Grind (No Rebirth)", Default = false})
...
if v.Name == "neededDurability" and v.Value == requiredDurability
and player.Character:FindFirstChild("LeftHand") and
...
local jungleToggle = Tabs.Rocks:CreateToggle("JungleRock", {Title = "Auto Punch
Jungle Rock (10M)", Default = false})
...
-- muscle king Rock
local kingToggle = Tabs.Rocks:CreateToggle("KingRock", {Title = "Auto Punch Muscle
King Rock (5M)", Default = false})
...
-- Legend Rock
local legendToggle = Tabs.Rocks:CreateToggle("LegendRock", {Title = "Auto Punch
Legend Rock (1M)", Default = false})
...
-- Inferno Rock
local infernoToggle = Tabs.Rocks:CreateToggle("InfernoRock", {Title = "Auto Punch
Inferno Rock (750K)", Default = false})
...
-- Mythical Rock
local mythToggle = Tabs.Rocks:CreateToggle("MythRock", {Title = "Auto Punch
Mythical Rock (400K)", Default = false})
...
-- Frost Rock
local frostToggle = Tabs.Rocks:CreateToggle("FrostRock", {Title = "Auto Punch Frost
Rock (150K)", Default = false})
...
-- Tiny Rock
local tinyToggle = Tabs.Rocks:CreateToggle("TinyRock", {Title = "Auto Punch Tiny
Rock (0)", Default = false})
...
local Toggle = Tabs.Killing:CreateToggle("AutoPunchNoAnim", {Title = "Auto Punch
(No Anim)", Default = false})
Toggle:OnChanged(function(state)
while state and Toggle.Value do
local player = game.Players.LocalPlayer
local char = game.Workspace:FindFirstChild(player.Name)
...
Callback = function()
local player = game.Players.LocalPlayer
local punch = player.Backpack:FindFirstChild("Punch") or
(game.Workspace:FindFirstChild(player.Name) and
game.Workspace[player.Name]:FindFirstChild("Punch"))
...
local AutokillToggle = Tabs.Killing:CreateToggle("AutoKill", {Title = "Auto Kill",
Default = false})
AutokillToggle:OnChanged(function(state)
while state and AutokillToggle.Value do
local player = game.Players.LocalPlayer
-- Auto punch setup
local punch = player.Backpack:FindFirstChild("Punch") or (player.Character
and player.Character:FindFirstChild("Punch"))
if punch and punch:FindFirstChild("attackTime") then
punch.attackTime.Value = 0.065
end
-- Auto kill logic
...
local root = target.Character and
target.Character:FindFirstChild("HumanoidRootPart")

local rHand = player.Character and
player.Character:FindFirstChild("RightHand")
local lHand = player.Character and
...
local Toggle = Tabs.Killing:CreateToggle("AutoKillTarget", {Title = "Auto Kill
...
CFrame.new(226.252472, 8.1526947, 219.366516, -0.00880406145, 3.58277887e-08, 0.999961257, -4.41204939e-08, 1, 3.62176351e-08, 0.999961257, 4.44376482e-08, 0.00880406145)
end
})
-- Beach
Tabs.Teleport:CreateButton({
...
Title = "Frost Gym",
Callback = function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2933.47998, 29.6399612, -579.946045, 0.0345239155, -1.03010173e-07, 0.999403894,
1.03015294e-08, 1, 1.02715752e-07, -0.999403894, 6.74923806e-09, 0.0345239155)
end
})
-- Mythical Gym
Tabs.Teleport:CreateButton({
...
Callback = function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
CFrame.new(2659.50635, 21.6095238, 934.690613, 0.999999881, 4.98906161e-08,
0.000502891606, -4.98585742e-08, 1, -6.37288338e-08, -0.000502891606, 6.37037516e08, 0.999999881)
end
})
-- Eternal Gym
Tabs.Teleport:CreateButton({
Title = "Eternal Gym",
Callback = function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(7176.19141, 45.394104, -1106.31421, 0.971191287, -2.38377185e-09, 0.238301158,
...
Callback = function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
CFrame.new(4446.91699, 1004.46698, -3983.76074, -0.999961317, -1.97616366e-08,
0.00879266672, -1.93830077e-08, 1, 4.31365149e-08, -0.00879266672, 4.29661292e-08,
-0.999961317)
end
})
-- Muscle King
...
paragraphs.StrengthGained:SetContent("Strength gained: " ..
abbreviateNumber(strengthStat.Value - initialStrength))
paragraphs.DurabilityGained:SetContent("Durability gained: " ..
abbreviateNumber(durabilityStat.Value - initialDurability))

paragraphs.AgilityGained:SetContent("Agility gained: " ..
abbreviateNumber(agilityStat.Value - initialAgility))
paragraphs.KillsGained:SetContent("Kills gained: " ..
abbreviateNumber(killsStat.Value - initialKills))
paragraphs.EvilKarmaGained:SetContent("Evil Karma gained: " ..
abbreviateNumber(evilKarmaStat.Value - initialEvilKarma))
paragraphs.GoodKarmaGained:SetContent("Good Karma gained: " ..
...
paragraphs.TimeSpent:SetContent(string.format("Time spent in this server:
...
Title = "Anti AFK",
Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/evxncodes/
mainroblox/main/anti-afk", true))()
end
})
...
Tabs.Misc:CreateToggle("DisableTrade", {Title = "Disable Trade", Default =
false}):OnChanged(function(state)
...
-- Hide Pets Toggle
Tabs.Misc:CreateToggle("HidePets", {Title = "Hide Pets", Default =
false}):OnChanged(function(state)
